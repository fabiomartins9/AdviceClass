...
export default function TabelaAlunos() {
  ...
  <div className="max-h-540 overflow-y-auto overflow-x-auto mx-4">
    <table ref={tableRef} className="table-auto border-collapse border border-gray-500 w-full px-4">
      <thead className="bg-gray-200 sticky -top-px z-10">
        <tr>
          <th className="border px-2 py-2 bg-gray-200 sticky top-0 z-10">Nome Aluno</th>
          {disciplinas && disciplinas.map((disciplina, index) => (
            <th key={index} className="border px-1 py-2 text-xs bg-gray-200 sticky top-0 z-10">
              {disciplina}
            </th>
          ))}
        </tr>
