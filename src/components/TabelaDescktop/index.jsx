...
export default function TabelaAlunos() {
  ...
  const handleSegundoSemestre = (e) => {
    //console.log(`checked = ${e.target.checked}`);
    setSegundoSemestre(e.target.checked);
  };
  ...
  <div className="w-40 mb-4 bg-white rounded-lg items-center">
  <span className="block mb-2 px-2 py-1 bg-orange-500 text-white rounded-t-lg text-xs	">EJA 2 SEMESTRE:</span>
    <Checkbox defaultChecked={false} className=" p-2 w-full border border-blue-500 rounded-b-lg text-xs items-center	" onChange={handleSegundoSemestre}></Checkbox>
  </div>
</div>
